...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class StashboxServiceCollectionExtensions
    {
        ...
        public static IServiceCollection Decorate<TService, TImplementation>(this IServiceCollection services, Action<DecoratorConfigurator<TService, TImplementation>> configurator = null)
        ...
        /// <param name="configurator">Optional service registration configuration.</param>
        /// <returns>The service collection.</returns>
        public static IServiceCollection Decorate<TImplementation>(this IServiceCollection services, Action<DecoratorConfigurator<TImplementation, TImplementation>> configurator = null)
        ...
        /// <param name="configurator">Optional service registration configuration.</param>
        /// <returns>The service collection.</returns>
        public static IServiceCollection Decorate(this IServiceCollection services, Type serviceType, Type implementationType, Action<DecoratorConfigurator> configurator = null)
        {
        ...
        /// <param name="configurator">Optional service registration configuration.</param>
        /// <returns>The service collection.</returns>
        public static IServiceCollection Decorate(this IServiceCollection services, Type implementationType, Action<DecoratorConfigurator> configurator = null)
        {
            Shield.EnsureNotNull(implementationType, nameof(implementationType));
