...
using Stashbox.Extensions.Dependencyinjection.Specificationtests.Fakes;
using Xunit;
using System.Linq;
...
namespace Stashbox.Extensions.Dependencyinjection.Specificationtests
{
    public class DependencyInjectionSpecificationTests
    {
        ...
        {
            return serviceCollection.AddStashboxServiceProvider();
        }
        ...
        [Fact(Skip = "Not supported scenario")]
